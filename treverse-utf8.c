 ...
 * compile-command: (let ((fn (file-name-sans-extension (file-name-nondirectory (buffer-file-name))))) (concat (default-value 'compile-command) " " fn " && ./" fn " 'english' '¡Hola!' 'Grüß Gott' 'Hyvää päivää' 'Tere õhtust' 'Bonġu' 'Cześć!' 'Dobrý den' 'Здравствуйте!' 'Γειά σας' 'გამარჯობა'"))
 * End:
 */
