 ...
 * compile-command: (let ((fn (file-name-sans-extension (file-name-nondirectory (buffer-file-name))))) (concat "rm -f " fn "; " (default-value 'compile-command) " CPPFLAGS='-DDO_MAIN' LDLIBS=-lm " fn " && echo 'run with one or more WSG-2000 .NAL files'"))
 * End:
 */
